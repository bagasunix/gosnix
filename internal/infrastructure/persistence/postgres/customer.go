...
func (g *gormProvider) FindAll(ctx context.Context, limit int, offset int, search string) (result base.SliceResult[*entities.Customer]) {
...
func (g *gormProvider) FindByParams(ctx context.Context, params map[string]interface{}) (result base.SingleResult[*entities.Customer]) {
...
func (g *gormProvider) Save(ctx context.Context, m *entities.Customer) error {
...
func (g *gormProvider) SaveTx(ctx context.Context, tx any, m *entities.Customer) error {
...
func (g *gormProvider) Updates(ctx context.Context, id int, m *entities.Customer) error {
...
func NewGormCustomer(logger *log.Logger, db *gorm.DB) repository.CustomerRepository {
	return &gormProvider{db: db, logger: logger}
}
